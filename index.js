...
const port = 5000;
const errors = {
  'DB_SERVER': 'Ughh! Database server not up properly. Please re-try! (Can use readme file for reference from step 1)',
  'DB_DUMP': 'Ughh! Database not up properly. Please re-try! (Can use readme file for reference from step 2)',
  'DB_TABLE': 'Ughh! Looks like database table not setup properly. Please re-try! (Can use readme file for reference step 2.5)'
}
